  ...
  <div class="bg-white rounded shadow w-2/3 p-4">
    <div class="flex justify-between items-center">
      ...
      <div class="flex-1 flex mx-4">
        <input v-model="postMessage" type="text" name="body" class="w-full pl-4 h-8 bg-gray-200 rounded-full focus:outline-none focus:ring-2 text-sm" placeholder="Add a post">
